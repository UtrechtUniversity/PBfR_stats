...
# Plot 2 line plot: 
# x = time
# y = average completion per participant in %
# How would we calculate the progress over the whole course? Because that is what we would need for a time-plot
# Row-wise percentage per participant, average that? Average of all blocks per participant * 100, average for all participants
